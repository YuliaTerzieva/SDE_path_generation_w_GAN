...
def gen_paths_from_GAN(gen_model, S_0, dt, n_steps, n_paths, actual_log_returns = None, Z_BM = None, my_device = 'mps'): 
    """
        ...
        S_0, n_steps, n_paths -> ints
        actual_log_returns -> numpy array
        Z_BM -> numpy array
        my_device -> string
    """
...
# def gen_paths_CIR(S_0 = 1, mu = 0.05, sigma = 0.2, dt = 0.05, n_steps = 100, n_paths = 1000):  
...
#         dW = (dt**(1/2))*Z[step_inx, :]
#         S_E[step_inx+1, :] = ? # Equation 9.16

#         S_M[step_inx+1, :] = ? # Equation between 9.17 and 9.18 :D
        
#         Exact_solution[step_inx+1, :] = ? # Equation 9.17

#         Log_Return[step_inx+1, :] = ?

#     return S_E, S_M, Exact_solution, Z, Log_Return

# def gen_paths_from_CIR(gen_model, S_0, dt, n_steps, n_paths, actual_log_returns = None, Z_BM = None, my_device = 'mps'): 
#     """
#         gen_model -> torch model
#         S_0, n_steps, n_paths -> ints
#         actual_log_returns -> numpy array
...
if __name__ == '__main__':
    np.random.seed(42)
    config_name = "supervised_GAN_one_dt_mu_0_05_sigma_0_2"
    S_0 = 1
    mu = 0.05
    sigma = 0.2
    n_steps = 100
    ...
    plt.plot(model_paths_self_gen[:, :100], alpha = 0.7, color = 'lightblue')
