...
def train_network(config_name, S_0, mu, sigma, n_steps, n_paths, dt, number_data_points, epochs, batch_size, advancing_C, log_freq, use_Z):

    ### Generating the SDE paths ###
    _, _, _, Z, Log_Return = gen_paths_GBM(S_0, mu, sigma, dt, n_steps, n_paths)
